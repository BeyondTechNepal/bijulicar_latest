...
@section('content')
    <div class="max-w-5xl mx-auto p-6 pb-20">
        ...
        <form action="{{ route('admin.news.update', $article->slug) }}" method="POST" enctype="multipart/form-data"
            ...
            {{-- Section: Category Selection (Edit Mode) --}}
                    ...
                    <div class="flex items-end pb-1">
                        <div class="space-y-1">
                            <p class="text-[9px] text-slate-400 font-mono uppercase leading-tight tracking-widest">
                                Current Node: <span
                                    class="text-indigo-500 font-bold">{{ $article->newscategory->name ?? 'Unassigned' }}</span>
                            </p>
                            <p class="text-[9px] text-slate-300 font-mono uppercase leading-tight tracking-widest">
                                Updating this registry will re-route the article globally.
                            </p>
                        </div>
                    </div>
                </div>
