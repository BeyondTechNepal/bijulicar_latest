...
<div class="max-w-2xl">
    <p class="text-slate-500 text-sm font-medium mb-8">
        Update your business's pin on the public map. Changes go live immediately.
    </p>
        ...
        <div class="p-6 border-t border-slate-100">
            ...
            <form method="POST" action="{{ route('business.location.update') }}">
                ...
                <div class="flex items-center gap-3 mt-6 pt-5 border-t border-slate-100">
                    <button type="submit"
                        class="px-6 py-2.5 bg-[#a855f7] hover:bg-[#9333ea] text-white text-sm font-black uppercase tracking-wider rounded-xl transition-all">
                        Update Location
                    </button>
