...
<body class="bg-[#f1f5f9] min-h-screen">
    <div class="flex min-h-screen">
        ...
        {{-- ── Sidebar ──────────────────────────────────────────────── --}}
        <aside id="sidebar" class="w-64 bg-slate-900 flex flex-col fixed inset-y-0 left-0 z-40 lg:translate-x-0 transition-transform duration-300">
            ...
            <nav class="flex-1 px-3 py-4 space-y-0.5 overflow-y-auto">
                ...
                @can('manage car listing(seller)')
                    <p class="text-[9px] font-black text-slate-600 uppercase tracking-widest px-3 py-2 mt-4">My Listings</p>
                ...
                @can('manage own orders')
                    <p class="text-[9px] font-black text-slate-600 uppercase tracking-widest px-3 py-2 mt-4">Sales</p>
                ...
                <a href="{{ route('seller.negotiations.index') }}"
                    ...
                    @if($pendingOffers > 0)
                        <span
                            class="ml-auto text-[10px] bg-amber-400 text-slate-900 px-1.5 py-0.5 rounded-full font-black">{{ $pendingOffers }}</span>
                    @endif
                </a>
        
                <p class="text-[9px] font-black text-slate-600 uppercase tracking-widest px-3 py-2 mt-4">Visibility</p>
