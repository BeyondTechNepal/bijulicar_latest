            ...
            <form method="POST" action="{{ route('seller.location.store') }}">
                ...
                <div class="space-y-4">
                    ...
                    <p class="text-[11px] text-emerald-700 font-medium bg-emerald-50 border border-emerald-200 rounded-xl px-4 py-2.5">
                        ✓ Your pin will go <strong>live on the map immediately.</strong>
                    </p>
                </div>

                <div class="flex items-center gap-3 mt-6 pt-5 border-t border-slate-100">
                    <button type="submit" id="submit-btn" disabled
                        class="px-6 py-2.5 bg-[#4ade80] hover:bg-[#22c55e] disabled:opacity-40 disabled:cursor-not-allowed text-slate-900 text-sm font-black uppercase tracking-wider rounded-xl transition-all">
                        Save Location
                    </button>
