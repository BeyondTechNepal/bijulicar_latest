...
<div class="flex items-center justify-between mb-6">
    <p class="text-slate-500 text-sm font-medium">Pin your showroom or dealership on the public map so buyers can find you.</p>
    @if (!$location)
        <a href="{{ route('seller.location.create') }}"
            class="inline-flex items-center gap-2 px-5 py-2.5 bg-[#4ade80] hover:bg-[#22c55e] text-slate-900 text-sm font-black uppercase tracking-wider rounded-xl transition-all shadow-sm">
...
@if (!$location)
    <div class="bg-white border border-dashed border-slate-300 rounded-3xl p-16 flex flex-col items-center justify-center text-center">
        <div class="w-14 h-14 bg-[#4ade80]/10 rounded-2xl flex items-center justify-center mb-4 border border-[#4ade80]/20">
            <svg class="w-7 h-7 text-[#4ade80]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="flex flex-col md:flex-row md:items-start justify-between gap-4">
                <div class="space-y-3">
                    ...
                    <div>
                        ...
                        {{-- Sellers always go live immediately --}}
                ...
                <div class="flex gap-3 shrink-0">
                    <a href="{{ route('seller.location.edit') }}"
                    ...
                    <form method="POST" action="{{ route('seller.location.destroy') }}"
