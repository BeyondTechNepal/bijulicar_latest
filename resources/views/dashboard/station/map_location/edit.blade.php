...
<div class="max-w-2xl">
    <p class="text-slate-500 text-sm font-medium mb-8">
        Update your station's pin on the public map. Click the map, search, or manually enter coordinates.
    </p>
    ...
    <div class="bg-white border border-slate-200 rounded-3xl overflow-hidden shadow-sm">
        ...
        <div class="p-6 border-t border-slate-100">
            ...
            <form method="POST" action="{{ route('station.location.update') }}">
                @csrf
                @method('PUT')
                ...
                <div class="flex items-center gap-3 mt-6 pt-5 border-t border-slate-100">
                    <button type="submit" id="submit-btn"
                        class="px-6 py-2.5 bg-emerald-500 hover:bg-emerald-600 text-white text-sm font-black uppercase tracking-wider rounded-xl transition-all">
                        Update Location
                    </button>
