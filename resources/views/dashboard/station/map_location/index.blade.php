...
<div class="flex items-center justify-between mb-6">
    <div>
        <p class="text-slate-500 text-sm font-medium">Manage your station's pinned location on the public map.</p>
    </div>
    @if (!$location)
        <a href="{{ route('station.location.create') }}"
            class="inline-flex items-center gap-2 px-5 py-2.5 bg-emerald-500 hover:bg-emerald-600 text-white text-sm font-black uppercase tracking-wider rounded-xl transition-all shadow-sm">
...
@if (!$location)
    ...
    <div class="bg-white border border-dashed border-slate-300 rounded-3xl p-16 flex flex-col items-center justify-center text-center">
        <div class="w-14 h-14 bg-emerald-50 rounded-2xl flex items-center justify-center mb-4 border border-emerald-100">
