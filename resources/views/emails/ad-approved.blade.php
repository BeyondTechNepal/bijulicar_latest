    ...
    <div style="max-width: 560px; margin: 0 auto; background: #ffffff; border-radius: 16px; overflow: hidden; border: 1px solid #e2e8f0;">
        ...
        <div style="padding: 36px 40px;">
            ...
            <p style="font-size: 14px; color: #475569; line-height: 1.7; margin: 0 0 24px;">
                Your advertisement has been reviewed and <strong style="color: #2563eb;">approved</strong>.
                Please complete your payment to get it live on the platform.
            </p>
            ...
            <div style="background: #f8fafc; border-radius: 10px; padding: 20px 24px; margin: 0 0 24px;">
                ...
                <table style="width: 100%; border-collapse: collapse;">
                    ...
                    <tr>
                        <td style="font-size: 13px; color: #94a3b8; padding: 8px 0 0;">Amount due</td>
                        <td style="font-size: 15px; color: #2563eb; font-weight: 900; padding: 8px 0 0;">
                            Rs {{ number_format($advertisement->charged_amount, 2) }}
                        </td>
                    </tr>
                </table>
            </div>
            ...
            <div style="background: #eff6ff; border-left: 4px solid #2563eb; border-radius: 8px; padding: 16px 20px; margin: 0 0 24px;">
                <p style="font-size: 11px; font-weight: 900; text-transform: uppercase; letter-spacing: 0.15em; color: #2563eb; margin: 0 0 10px;">
                    Payment Options
                </p>
            ...
            <p style="font-size: 14px; color: #475569; line-height: 1.7; margin: 0 0 24px;">
                Once we confirm your payment, your ad will go live and you'll receive another email.
            </p>
