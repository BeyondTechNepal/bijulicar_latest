    ...
    <div style="max-width: 560px; margin: 0 auto; background: #ffffff; border-radius: 16px; overflow: hidden; border: 1px solid #e2e8f0;">
        ...
        <div style="padding: 36px 40px;">
            ...
            <p style="font-size: 14px; color: #475569; line-height: 1.7; margin: 0 0 24px;">
                Unfortunately, the garage was unable to confirm your appointment request for
                <strong style="color: #0f172a;">{{ $appointment->service_description }}</strong>
                on <strong style="color: #0f172a;">{{ $appointment->requested_at->format('D, d M Y') }}</strong>.
            </p>
            ...
            <p style="font-size: 14px; color: #475569; line-height: 1.7; margin: 0 0 24px;">
                You can search for other available garages on the BijuliCar map and try booking again.
            </p>
