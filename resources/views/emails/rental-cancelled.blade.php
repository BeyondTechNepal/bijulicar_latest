        ...
        <div style="padding: 36px 40px;">
            ...
            <p style="font-size: 14px; color: #475569; line-height: 1.7; margin: 0 0 24px;">
                @if ($cancelledBy === 'renter')
                    The renter has <strong style="color: #dc2626;">cancelled</strong> their booking for this car.
                @else
                    The owner has <strong style="color: #dc2626;">cancelled</strong> your rental booking.
                @endif
            </p>
            ...
            <div style="background: #f8fafc; border: 1px solid #e2e8f0; border-radius: 12px; padding: 20px 24px; margin: 0 0 24px;">
                <table style="width: 100%; border-collapse: collapse; font-size: 13px;">
                    ...
                    <tr style="border-top: 1px solid #f1f5f9;">
                        <td style="padding: 8px 0; color: #94a3b8; font-weight: 700; text-transform: uppercase; font-size: 10px; letter-spacing: 0.1em;">Reason</td>
                        <td style="padding: 8px 0; color: #475569;">{{ $rental->cancellation_reason }}</td>
                    </tr>
                    @endif
                </table>
            </div>
