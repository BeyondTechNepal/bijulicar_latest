<header class="fixed top-0 left-0 w-full flex justify-center pt-4 md:pt-6 z-50">
    ...
    <div class="absolute top-24 left-1/2 -translate-x-1/2 w-[92%] bg-white rounded-[1.5rem] shadow-2xl border border-slate-100 transform scale-95 transition-transform duration-300 origin-top" id="menuCard">
