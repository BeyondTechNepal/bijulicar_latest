<header class="fixed top-0 left-0 w-full flex justify-center pt-4 md:pt-6 z-50">
        ...
        <div class="flex items-center space-x-2 md:space-x-4">
            <div class="hidden lg:flex items-center space-x-0 xl:space-x-2">
                ...
                <a href="{{ route('contact') }}"
                    class="px-2 xl:px-3 py-2 rounded-xl text-[12px] xl:text-[14px] font-bold {{ Route::is('contact') ? 'text-green-600 bg-green-50' : 'text-slate-800 hover:bg-slate-50' }}">Contact</a>
                    ...
                    <div class="relative" id="userMenuWrapper">
                        <button onclick="toggleUserMenu()"
                            ...
                            <div class="relative">
                                ...
                                @if ($unreadCount > 0)
                                    <span
                                        class="absolute -top-1 -right-1 min-w-[16px] h-4 px-1 bg-red-500 text-white text-[9px] font-black rounded-full flex items-center justify-center leading-none">
                        ...
                        <div id="userDropdown"
                            ...
                            <div class="px-4 py-3 border-b border-slate-100 flex items-center gap-3">
                                ...
                                @else
                                    <div
                                        class="w-9 h-9 rounded-xl bg-slate-900 flex items-center justify-center text-white text-xs font-black uppercase shrink-0">
                                        {{ strtoupper(substr($user->name, 0, 2)) }}
                                    </div>
                                @endif
                                <div class="min-w-0">
                            ...
                            <a href="{{ route('notifications.index') }}"
                                ...
                                @if ($unreadCount > 0)
                                    <span
                                        class="text-[10px] font-black bg-red-100 text-red-600 px-1.5 py-0.5 rounded-full leading-none">
                                        {{ $unreadCount > 9 ? '9+' : $unreadCount }}
                                    </span>
                                @endif
                            </a>
    ...
    <div id="mobileMenu" class="fixed inset-0 z-[-1] invisible opacity-0 transition-all duration-300">
        ...
        <div class="absolute top-24 left-1/2 -translate-x-1/2 w-[92%] bg-white rounded-[1.5rem] shadow-2xl border border-slate-100 transform scale-95 transition-transform duration-300 origin-top"
            id="menuCard">
            <div class="overflow-y-auto scrollbar-hide-nav max-h-[80dvh] p-5">
                ...
                <div class="flex flex-col space-y-1 ">
                    ...
                    @auth
                        ...
                        <a href="{{ $dashRoute }}"
                            class="flex items-center justify-between p-4 rounded-2xl font-bold text-sm">
                    ...
                    <a href="{{ route('marketplace') }}"
                        ...
                        <span class="text-lg"><i class="fa-solid fa-cart-shopping"
                                style="color: rgb(55, 225, 175);"></i></span>
                    </a>

                    <a href="{{ route('rent') }}"
                        class="flex items-center justify-between p-4 rounded-2xl {{ Route::is('rent') ? 'bg-blue-50 text-green-600' : 'bg-slate-50 text-slate-700' }}">
                        <span class="font-bold">Rent a Car</span>
                        <span class="text-lg"><i class="fa-solid fa-car"
                                style="color: rgb(55, 225, 175);"></i></span>
                    </a>
                    ...
                    <a href="{{ route('news') }}"
                        ...
                        <span class="text-lg"><i class="fa-solid fa-newspaper"
                                style="color: rgb(55, 225, 175);"></i></span>
                    </a>
                    ...
                    <a href="{{ route('loan_calculator') }}"
                        ...
                        <span class="text-lg"><i class="fa-solid fa-wallet"
                                style="color: rgb(55, 225, 175);"></i></span>
                    </a>
                    ...
                    <a href="{{ route('compare_cars') }}"
                        ...
                        <span class="text-lg"><i class="fa-solid fa-exchange-alt"
                                style="color: rgb(55, 225, 175);"></i></span>
                    </a>
                    ...
                    <a href="{{ route('map_location') }}"
                        ...
                        <span class="text-lg"><i class="fa-solid fa-map-location"
                                style="color: rgb(55, 225, 175);"></i></span>
                    </a>
                    ...
                    <a href="{{ route('contact') }}"
                        ...
                        <span class="text-lg"><i class="fa-solid fa-phone"
                                style="color: rgb(55, 225, 175);"></i></span>
                    </a>
