...
@section('content')
    ...
    <div class="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <h1 class="text-4xl md:text-6xl lg:text-7xl font-black tracking-tighter text-white uppercase italic leading-[0.80] mb-4">
            <span class="block">Business</span>
            <span class="text-slate-500">Directory</span>
        </h1>

        <p class="text-slate-400 text-xs lg:text-sm font-medium max-w-sm leading-relaxed opacity-80">
            Discover Nepal's verified EV and hybrid dealerships. Browse live inventory, read reviews, and connect directly.
        </p>

        {{-- Stats Strip --}}
        <div class="mt-6 flex flex-wrap gap-3 lg:gap-4">
            <div class="flex items-center gap-3 bg-white/5 border border-white/10 backdrop-blur-md rounded-xl px-4 py-2.5">
                <div class="w-7 h-7 bg-[#4ade80]/10 rounded-lg flex items-center justify-center">
                ...
                <div>
                    <p class="text-lg font-black text-white leading-none">{{ $totalBusinesses }}</p>
                    <p class="text-[8px] font-bold text-slate-500 uppercase tracking-wider mt-0.5">Businesses</p>
                </div>
            </div>
            ...
            <div class="flex items-center gap-3 bg-white/5 border border-white/10 backdrop-blur-md rounded-xl px-4 py-2.5">
                ...
                <div>
                    <p class="text-lg font-black text-white leading-none">{{ $totalListings }}</p>
                    <p class="text-[8px] font-bold text-slate-500 uppercase tracking-wider mt-0.5">Listings</p>
                </div>
            </div>
                    ...
                    @foreach ($businesses as $biz)
                        <a href="{{ $biz['profile_url'] }}"
                            ...
                            <div class="px-6 pb-4">
                                ...
                                @endphp
                                <span
                                    class="text-[11px] font-black px-3 py-1 rounded-full border {{ $tagColor }} uppercase tracking-wide">
                                    {{ $biz['specialization'] }}
                                </span>
                            </div>
                            ...
                            <div class="px-6 py-4 grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <p class="text-[10px] font-bold text-slate-400 uppercase tracking-wide mt-0.5">Active
                                        Listings</p>
                                </div>
                                <div>
                                ...
                                <div class="flex items-center justify-between">
                                    <div class="flex items-center gap-3 text-[11px] font-bold text-slate-500">
                                        @if ($article->newscategory)
                                            <span
                                                class="text-purple-400 uppercase tracking-wider">{{ $article->newscategory->name }}</span>
                                            <span>·</span>
                                        @endif
                                        <span>{{ $article->created_at->format('d M Y') }}</span>
                                    </div>
                                    <span
                                        class="text-[11px] font-black text-[#a855f7] uppercase tracking-wider flex items-center gap-1 group-hover:gap-2 transition-all">
                                        Read
        ...
        <section class="bg-[#0a0f1e] py-16">
            <div class="max-w-3xl mx-auto px-6 text-center">
                ...
                <p class="text-slate-400 text-sm leading-relaxed mb-8 max-w-md mx-auto">
                    Are you an EV or hybrid dealership? Join BijuliCar's verified business network and reach thousands of
                    buyers.
                </p>
