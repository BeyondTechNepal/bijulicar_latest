...
<head>
    ...
    <title>Bijulicar | Buyer Verification</title>
    ...
    <main class="flex h-full w-full">
        ...
        <section class="hidden lg:block w-[50%] h-full relative bg-slate-900">
            <img src="https://images.unsplash.com/photo-1560958089-b8a1929cea89?q=80&w=2071&auto=format&fit=crop"
                class="absolute inset-0 w-full h-full object-cover opacity-50 grayscale-[0.2]" alt="Car buyer">
            ...
            <div class="absolute top-1/2 left-16 -translate-y-1/2">
                <div class="flex items-center gap-2 mb-6">
                    ...
                    <p class="text-[10px] font-black text-[#4ade80] uppercase tracking-[0.4em]">Buyer Verification</p>
                </div>
                <h2 class="text-6xl font-black text-white uppercase italic tracking-tighter leading-[0.9] mb-6">
                    BUY WITH <br>CONFIDENCE <span class="text-[#4ade80]">TODAY.</span>
                </h2>
        ...
        <section class="w-full lg:w-[50%] h-full flex flex-col justify-center px-8 md:px-20 bg-white relative z-10 overflow-y-auto no-scrollbar">
            ...
            <div class="mb-6">
                <h1 class="text-3xl font-black text-slate-900 uppercase italic tracking-tighter">
                    Buyer <span class="text-[#16a34a]">Details</span>
                </h1>
                <p class="text-slate-500 text-sm font-medium mt-1">
                    Submit your details so our team can verify your identity before you start purchasing.
                </p>
            </div>
            ...
            {{-- Form --}}
            <form method="POST" action="{{ route('buyer.verify.store') }}" enctype="multipart/form-data" class="space-y-4">
                @csrf
